...
namespace RMSKOT
{
    public partial class TouchableFlowLayoutPanel : FlowLayoutPanel
    {
        ...
        private MouseFilter _mouseFilter = new MouseFilter();
        /// <summary>
        ...
        public TouchableFlowLayoutPanel()
        {
            ...
            _mouseFilter.MouseFilterDown += mouseFilter_MouseFilterDown;
            _mouseFilter.MouseFilterMove += mouseFilter_MouseFilterMove;
            _mouseFilter.MouseFilterUp += mouseFilter_MouseFilterUp;
        }
    ...
    public delegate void MouseFilterEventHandler(object sender, MouseFilterEventArgs args);

    public delegate void MouseFilterMoveEventHandler(object sender, MouseFilterEventArgs args);

    public class MouseFilterEventArgs
    {
        /// <summary>
